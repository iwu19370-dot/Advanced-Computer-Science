...
public class DebugDemoStudent {
    ...
    public static int getFifthElement(int[] arr) {
        // array can be null itself
        if (arr == null) {
            throw new IllegalArgumentException("Array is null!");
        }
        // not enough elements, or array is less than 5 elements
        if (arr.length < 5) {
    ...
    public static int getStringLength(String str) {
        if (str == null) {
            throw new NullPointerException("The String doesn't exsist!");
        }
        return str.length();
    }
    ...
    public static int squareRootFloor(int n) {
        if (n < 0) {
            throw new IllegalArgumentException("You can't have a negative number.");
        }
    ...
    public static String slice(String word, int start, int end) {
        ...
        if (start < 0 || end < 0) {
            throw new IllegalArgumentException("The start and end are negative.");
        }
        if (start >= end) {
            throw new IllegalArgumentException("The start is less than the end.");
        }
